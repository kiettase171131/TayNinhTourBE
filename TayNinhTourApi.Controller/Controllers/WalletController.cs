    ...
    public class WalletController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMyWallet()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    StatusCode = 500,
                    Message = "Lỗi hệ thống khi lấy thông tin ví",
                    Success = false
                });
            }
        }
        ...
        public async Task<IActionResult> GetTourCompanyWallet()
        {
            try
            {
                ...
                if (userId == Guid.Empty)
                {
                    ...
                    return BadRequest("Không tìm thấy thông tin user trong token");
                }
            ...
            catch (Exception ex)
            {
                ...
                {
                    StatusCode = 500,
                    Message = "Lỗi hệ thống khi lấy thông tin ví công ty tour",
                    Success = false
                });
            }
        }
        ...
        public async Task<IActionResult> GetSpecialtyShopWallet()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    StatusCode = 500,
                    Message = "Lỗi hệ thống khi lấy thông tin ví shop",
                    Success = false
                });
            }
        }
        ...
        public async Task<IActionResult> HasWallet()
        {
            try
            {
                ...
                {
                    StatusCode = 200,
                    Message = hasWallet ? "User có ví tiền" : "User chưa có ví tiền",
                    Success = true,
                    Data = new
                    {
                        HasWallet = hasWallet,
            ...
            catch (Exception ex)
            {
                ...
                {
                    StatusCode = 500,
                    Message = "Lỗi hệ thống khi kiểm tra trạng thái ví",
                    Success = false
                });
            }
        }
        ...
        public async Task<IActionResult> GetWalletType()
        {
            try
            {
                ...
                {
                    StatusCode = 200,
                    Message = walletType != null ? "Lấy loại ví thành công" : "User chưa có ví",
                    Success = true,
                    Data = new
                    {
                        WalletType = walletType
            ...
            catch (Exception ex)
            {
                ...
                {
                    StatusCode = 500,
                    Message = "Lỗi hệ thống khi lấy loại ví",
                    Success = false
                });
            }
        }
