...
namespace TayNinhTourApi.DataAccessLayer.Migrations
{
    ...
    [Migration("20250813013154_AddGroupBookingSupport")]
    partial class AddGroupBookingSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.AIChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.AIChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("BankAccounts", null, t =>
                        {
                            t.HasCheckConstraint("CK_BankAccount_AccountNumber_Numeric", "AccountNumber REGEXP '^[0-9]+$'");
                        });
                });
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.ShopCustomerStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("IsUpcomingVisitor")
                        .HasColumnType("tinyint(1)");

                    b.Property<DateOnly?>("NextTourDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("SpecialtyShopId", "CustomerUserId")
                        .IsUnique();

                    b.ToTable("ShopCustomerStatuses");
                });
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourBookingGuest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("TourBookingId", "GuestEmail")
                        .IsUnique()
                        .HasDatabaseName("UQ_TourBookingGuests_Email_Booking")
                        .HasFilter("IsDeleted = 0")
                        .HasAnnotation("SqlServer:IncludeProperties", "GuestName");

                    b.ToTable("TourBookingGuests", null, t =>
                        {
                            t.HasComment("Bảng lưu trữ thông tin từng khách hàng trong tour booking với QR code riêng");

                            t.HasCheckConstraint("CK_TourBookingGuests_GuestEmail_NotEmpty", "LENGTH(TRIM(GuestEmail)) > 0");

                            t.HasCheckConstraint("CK_TourBookingGuests_GuestName_NotEmpty", "LENGTH(TRIM(GuestName)) > 0");
                        });
                });
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourCompany", b =>
                {
                    ...
                    b.ToTable("TourCompanies", null, t =>
                        {
                            t.HasCheckConstraint("CK_TourCompanies_RevenueHold_NonNegative", "`RevenueHold` >= 0");

                            t.HasCheckConstraint("CK_TourCompanies_Wallet_NonNegative", "`Wallet` >= 0");
                        });
                });
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourIncident", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("ReportedByGuideId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ReportedByGuideId");

                    b.HasIndex("TourOperationId");

                    b.HasIndex("UpdatedById");

                    b.ToTable("TourIncidents");
                });
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.WithdrawalRequest", b =>
                {
                    ...
                    b.ToTable("WithdrawalRequests", null, t =>
                        {
                            t.HasCheckConstraint("CK_WithdrawalRequest_Amount_Positive", "Amount > 0");

                            t.HasCheckConstraint("CK_WithdrawalRequest_ProcessedAt_Logic", "(Status = 0 AND ProcessedAt IS NULL) OR (Status != 0 AND ProcessedAt IS NOT NULL)");

                            t.HasCheckConstraint("CK_WithdrawalRequest_WalletBalance_NonNegative", "WalletBalanceAtRequest >= 0");

                            t.HasCheckConstraint("CK_WithdrawalRequest_WithdrawalFee_NonNegative", "WithdrawalFee >= 0");
                        });
                });
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.AIChatMessage", b =>
                {
                    b.HasOne("TayNinhTourApi.DataAccessLayer.Entities.AIChatSession", "Session")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.BankAccount", b =>
                {
                    ...
                    b.HasOne("TayNinhTourApi.DataAccessLayer.Entities.User", "VerifiedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.ShopCustomerStatus", b =>
                {
                    b.HasOne("TayNinhTourApi.DataAccessLayer.Entities.User", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourCompany", b =>
                {
                    b.HasOne("TayNinhTourApi.DataAccessLayer.Entities.User", "User")
                        .WithOne("TourCompany")
                        .HasForeignKey("TayNinhTourApi.DataAccessLayer.Entities.TourCompany", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourFeedback", b =>
                {
                    b.HasOne("TayNinhTourApi.DataAccessLayer.Entities.TourBooking", "TourBooking")
                        .WithOne("Feedback")
                        .HasForeignKey("TayNinhTourApi.DataAccessLayer.Entities.TourFeedback", "TourBookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TayNinhTourApi.DataAccessLayer.Entities.TourIncident", b =>
                {
                    ...
                    b.HasOne("TayNinhTourApi.DataAccessLayer.Entities.TourGuide", "ReportedByGuide")
                        .WithMany()
                        .HasForeignKey("ReportedByGuideId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
