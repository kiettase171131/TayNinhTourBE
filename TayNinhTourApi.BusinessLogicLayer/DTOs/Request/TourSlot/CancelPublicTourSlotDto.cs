...
namespace TayNinhTourApi.BusinessLogicLayer.DTOs.Request.TourSlot
{
    ...
    public class CancelPublicTourSlotDto
    {
        ...
        /// </summary>
        [Required(ErrorMessage = "Lý do h?y tour là b?t bu?c")]
        [StringLength(1000, MinimumLength = 10, ErrorMessage = "Lý do h?y ph?i t? 10 ??n 1000 ký t?")]
        public string Reason { get; set; } = null!;

        /// <summary>
        /// Thông ?i?p b? sung g?i cho khách hàng (tùy ch?n)
        /// </summary>
        [StringLength(500, ErrorMessage = "Thông ?i?p b? sung không ???c quá 500 ký t?")]
